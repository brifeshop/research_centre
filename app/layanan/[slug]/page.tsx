...
export default function LayananDetailPage() {
  ...
  const serviceData = t.layanan.services.items.find(
    (item: any) => {
  ...
  const slugToTitle: { [key: string]: string } = {
    elektronika: "Rekayasa Elektronika & Embedded Systems",
    agroteknologi: "Inovasi Pemuliaan & Agroteknologi",
    edukasi: "Pengembangan Alat Pendidikan STEM",
    instrumentasi: "Sistem Instrumentasi & Kendali Terpadu",
  };
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      <section className="relative min-h-[50vh] flex items-center text-white pt-32 pb-20 px-6 md:px-12 lg:px-24 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url(${serviceData.image || "https://images.unsplash.com/photo-1518770660439-4636190af475?w=1600&auto=format&fit=crop&q=80"})`,
          }}
        />
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className="flex items-center justify-center gap-3 mb-4">
            <span className="text-5xl">{serviceData.icon}</span>
          </div>
      ...
      <section className="py-4 px-6 md:px-12 lg:px-24 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto">
          <nav className="flex items-center gap-2 text-sm text-slate-500">
            ...
            <span>/</span>
            <Link href="/layanan" className="hover:text-blue-600 transition-colors">Layanan</Link>
            <span>/</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-sm border border-slate-200">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-slate-50 rounded-2xl p-6 border border-blue-100">
                <h4 className="font-bold text-slate-900 mb-2">Tertarik dengan layanan ini?</h4>
                <p className="text-sm text-slate-600 mb-4">Konsultasikan kebutuhan Anda dengan tim ahli kami.</p>
                <Link
                  href="/kontak"
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200">
              <h3 className="font-bold text-slate-900 mb-4">Layanan Lainnya</h3>
              <div className="space-y-3">
                {t.layanan.services.items
                  .filter((item: any) => item.id !== serviceData.id)
                  .map((item: any) => (
                    <Link
                      key={item.id}
                      href={item.link}
